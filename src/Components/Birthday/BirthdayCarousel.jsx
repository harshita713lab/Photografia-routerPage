...
// ✅ Local image imports
import slide1 from '../../assets/birthday/image/img1.jpg';
import slide2 from '../../assets/birthday/image/birthday2.jpg';
import slide3 from '../../assets/birthday/image/birthday3.jpg';
import slide4 from '../../assets/birthday/image/birthday4.jpg';
...
const BirthdayCarousel = () => {
  ...
  return (
    <div className="birthday-carousel scroll-fade-up">
      <div className="carousel-header">
        <h2 className="carousel-title scroll-fade-up delay-1">Birthday Moments</h2>
        <div className="carousel-line scroll-fade-up delay-2"></div>
        <p className="carousel-subtitle scroll-fade-up delay-3">A collection of beautiful birthday celebrations</p>
      </div>
